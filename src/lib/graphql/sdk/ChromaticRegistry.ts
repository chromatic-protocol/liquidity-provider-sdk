...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    LpList(variables?: LpListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpListQuery>(LpListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LpList', 'query', variables);
    },
    LpListByMarket(variables: LpListByMarketQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpListByMarketQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpListByMarketQuery>(LpListByMarketDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LpListByMarket', 'query', variables);
    },
    LpListBySettlementToken(variables: LpListBySettlementTokenQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpListBySettlementTokenQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpListBySettlementTokenQuery>(LpListBySettlementTokenDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LpListBySettlementToken', 'query', variables);
    }
  };
}
