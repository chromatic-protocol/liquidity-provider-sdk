...
export type LpQuery = { __typename?: 'Query', chromaticLP?: { __typename?: 'ChromaticLP', id: `0x${string}`, longShortInfo: number, lpTokenDecimals: number, lpTokenSymbol: string, lpTokenName: string, market: `0x${string}`, oracleDescription: string, oracleProvider: `0x${string}`, rebalanceBPS: string, rebalanceCheckingInterval: string, settlementTokenDecimals: number, settlementToken: `0x${string}`, settlementTokenSymbol: string, utilizationTargetBPS: string, clbTokenIds: Array<string>, distributionRates: Array<number>, feeRates: Array<number> } | null };

export type LpMetaQueryVariables = Exact<{
  lpAddress: Scalars['Bytes']['input'];
}>;


export type LpMetaQuery = { __typename?: 'Query', chromaticLPMetas: Array<{ __typename?: 'ChromaticLPMeta', lpName: string, lpTag: string }> };

export type LpConfigQueryVariables = Exact<{
  lpAddress: Scalars['Bytes']['input'];
}>;


export type LpConfigQuery = { __typename?: 'Query', chromaticLPConfigs: Array<{ __typename?: 'ChromaticLPConfig', minHoldingValueToRebalance: string, automationFeeReserved: string }> };
...
export const LpDocument = gql`
  ...
  chromaticLP(id: $lpAddress) {
    ...
    `;
export const LpMetaDocument = gql`
  ...
  chromaticLPMetas(
    ...
    `;
export const LpConfigDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    LP(variables: LpQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpQuery>(LpDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LP', 'query');
    },
    LPMeta(variables: LpMetaQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpMetaQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpMetaQuery>(LpMetaDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LPMeta', 'query');
    },
    LPConfig(variables: LpConfigQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpConfigQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpConfigQuery>(LpConfigDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LPConfig', 'query');
    },
    LPStat(variables: LpStatQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LpStatQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LpStatQuery>(LpStatDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LPStat', 'query');
    },
    GetReceiptsOf(variables: GetReceiptsOfQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetReceiptsOfQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetReceiptsOfQuery>(GetReceiptsOfDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetReceiptsOf', 'query');
    },
