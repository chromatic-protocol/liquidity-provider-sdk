...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    BpList(variables?: BpListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BpListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BpListQuery>(BpListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BpList', 'query');
    },
    BpListByLp(variables: BpListByLpQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BpListByLpQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BpListByLpQuery>(BpListByLpDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BpListByLp', 'query');
    }
  };
}
