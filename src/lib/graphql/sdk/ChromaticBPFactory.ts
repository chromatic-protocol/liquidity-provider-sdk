...
export type BpListQueryVariables = Exact<{ [key: string]: never; }>;


export type BpListQuery = { __typename?: 'Query', chromaticBPCreateds: Array<{ __typename?: 'ChromaticBPCreated', bp: `0x${string}` }> };

export type BpListByLpQueryVariables = Exact<{
  lp: Scalars['Bytes']['input'];
}>;


export type BpListByLpQuery = { __typename?: 'Query', chromaticBPCreateds: Array<{ __typename?: 'ChromaticBPCreated', bp: `0x${string}` }> };


export const BpListDocument = gql`
    query BpList {
  chromaticBPCreateds {
    bp
  }
    ...
    `;
export const BpListByLpDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    BpList(variables?: BpListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BpListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BpListQuery>(BpListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BpList', 'query', variables);
    },
    BpListByLp(variables: BpListByLpQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BpListByLpQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BpListByLpQuery>(BpListByLpDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BpListByLp', 'query', variables);
    }
  };
}
